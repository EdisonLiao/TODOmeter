...
package com.toolutil.todomine.ui.main
...
import com.toolutil.todomine.domain.model.AppThemePreference
...
import com.toolutil.todomine.domain.usecase.DeleteProjectUseCase
import com.toolutil.todomine.domain.usecase.DeleteTaskUseCase
import com.toolutil.todomine.domain.usecase.GetAppThemePreferenceUseCase
import com.toolutil.todomine.domain.usecase.GetProjectSelectedIdUseCase
import com.toolutil.todomine.domain.usecase.GetProjectSelectedUseCase
import com.toolutil.todomine.domain.usecase.GetProjectsUseCase
import com.toolutil.todomine.domain.usecase.GetTaskUseCase
import com.toolutil.todomine.domain.usecase.InsertProjectUseCase
import com.toolutil.todomine.domain.usecase.InsertTaskUseCase
import com.toolutil.todomine.domain.usecase.SetAppThemePreferenceUseCase
import com.toolutil.todomine.domain.usecase.SetProjectSelectedUseCase
import com.toolutil.todomine.domain.usecase.SetTaskDoingUseCase
import com.toolutil.todomine.domain.usecase.SetTaskDoneUseCase
import com.toolutil.todomine.domain.usecase.UpdateProjectUseCase
import com.toolutil.todomine.domain.usecase.UpdateTaskUseCase
